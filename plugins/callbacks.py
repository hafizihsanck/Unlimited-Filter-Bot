...
async def cb_handler(client, query):
    ...
    if query.data == "start_data":
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("Creater", url="https://t.me/ihsan_bin_ahmd"),
                    InlineKeyboardButton("About Me", callback_data="about_data")
                ],
                [
                    InlineKeyboardButton("Channel", url="https://t.me/joinchat/ehFX99SheBI3ZGZl"),
                    InlineKeyboardButton("Group", url="https://t.me/Moveis_hund")
                ]
            ]
        )
